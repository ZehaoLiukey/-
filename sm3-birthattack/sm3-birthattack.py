...
if __name__ == '__main__':
    ...
    a=int(input("请输入长度(单位为一个字)："))
    time_start = time.time()
    naivebirth(a)
    time_end = time.time()
    print(4*a,'比特攻击用时', time_end - time_start, 's')